...
import { goToProfile,goToRestaurant, goToMyCartPage } from "../../routes/coordinator";
...
const Footer = () => {
  ...
  return(
  <FooterContainer>
     <IconImage src={history.location.pathname === "/profile" ? avatarRed : avatar}
          alt="avatar"
          onClick={() => goToProfile(history)} />
            <IconImage src={history.location.pathname === "/restaurant" ? homeRed : home}
          alt="home"
